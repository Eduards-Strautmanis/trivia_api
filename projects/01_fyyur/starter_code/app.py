...
#test class for when I was debuging the rest of the database. Will be deleted at the end
class Test(db.Model):
  __tablename__ = 'tests'
...
def create_venue_submission():
  ...
  try:
    #try: #TODO: find an actual solution
    #  talent = request.form['seeking_talent']
    #  talent = True
    #except:
    #  talent = False
